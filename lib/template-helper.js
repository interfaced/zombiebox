...
class TemplateHelper {
	...
	render(filename, data) {
		...
		logger.silly(`Rendering ${filename} from ${chalk.underline(src)}`);
	...
	renderDir(templatePath, dst, data) {
		...
		logger.silly(`Rendering directory ${templatePath} from ${chalk.underline(src)} into ${chalk.underline(dst)}`);
