...
const StylesCache = require('./styles-cache');
...
class Application extends EventEmitter {
	 ...
	 * @return {string}
	 */
	getIndexHTMLContent(opt_options = {}) {
	...
	_initAddons(customAddons) {
		...
		this._addonLoader.getExtensions().forEach((extension) => {
			extension.setTemplateHelper(this._templateHelper);
		});
	}
	...
	_initCodeSource() {
		...
		this._stylesCache = new StylesCache(
			this._codeSource.fs,
			this._config.postcss
		);
	}
