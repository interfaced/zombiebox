 ...
 * @interface
 **/
export class IBuildOptions {
	/** */
	constructor() {
		/**
		 * Inline bundled CSS code into index.html body
		 * @type {boolean}
		 */
		this.inlineCSS;

		/**
		 * Inline bundled JS code into index.html body
		 * @type {boolean}
		 */
		this.inlineJS;
	}
