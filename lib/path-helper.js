...
import {resolveNPMModule, resolve} from './utils.js';
import {createChild} from './logger.js';
const logger = createChild('Path');
	...
	constructor(root) {
		...
		try {
			...
			this._installedZbPath = path.dirname(
				resolveNPMModule(
					import.meta.url,
					'zombiebox/package.json', // eslint-disable-line node/no-extraneous-require
			...
			this._installedZbPath = resolve(import.meta.url, '..');
		}
