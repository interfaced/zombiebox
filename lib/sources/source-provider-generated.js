...
class SourceProviderGenerated extends SourceProviderBase {
	...
	clean() {
		...
		logger.debug(`Cleaning up ${chalk.underline(this._root)}`);
	 ...
	 * @protected
	 */
	_onExtensionGeneratedCode(extension, sources) {
		logger.debug(
			`Extension ${chalk.green(extension.getName())} generated files: \n\t` +
	...
	_writeFile(src, content) {
		...
		logger.silly(`Generated file ${chalk.underline(filename)}`);
